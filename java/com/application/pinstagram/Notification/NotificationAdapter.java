...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.viewHolder> {
    ...
    List<NotificationModel1> list;
    Context context;

    public NotificationAdapter(List<NotificationModel1> list, Context context) {
        this.list = list;
...
//        holder.time.setText(model.getTime());
        NotificationModel1 model = list.get(position);
        holder.notification.setText(model.getContent());
        holder.time.setText(model.getUserId());
    }
