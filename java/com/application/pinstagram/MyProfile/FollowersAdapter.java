...
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.viewHolder> {
    ...
    public FollowersAdapter(ArrayList<NotificationReqModel> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rv_followitem, parent, false);
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            following = itemView.findViewById(R.id.btfollowing);
